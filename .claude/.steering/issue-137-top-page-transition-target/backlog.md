...
- [ ] 障害物 / 歩数制限 / 一方通行セル（パズル性、「挑戦」「工夫」実現の中心方針）
  ...
  - 要素ごとに個別 steering へ分割: [障害物](20260916-obstacles/design.md) / [歩数制限](20260916-step-limit/design.md) / [一方通行セル](_closed/pr-180-one-way-cell/design.md)
  - 障害物は proto-01（PR #176）・proto-03（[20260916-proto03-obstacles/decision-records.md](20260916-proto03-obstacles/decision-records.md) 2026-09-16）で実装済み。一方通行セルは proto-01・proto-03 双方に実装済み（PR #180）。歩数制限は未着手
