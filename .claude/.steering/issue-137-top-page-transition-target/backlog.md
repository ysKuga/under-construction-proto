...
- [ ] 障害物 / 歩数制限 / 一方通行セル（パズル性、「挑戦」「工夫」実現の中心方針）
  ...
  - 要素ごとに個別 steering へ分割: [障害物](20260916-obstacles/design.md) / [エネルギー](20260916-energy/design.md)（歩数制限から改称、decision-records.md 2026-09-16） / [一方通行セル](20260916-one-way-cell/design.md)
  - 障害物は proto-01（PR #176）・proto-03（[20260916-proto03-obstacles/decision-records.md](20260916-proto03-obstacles/decision-records.md) 2026-09-16）で実装済み。エネルギーは検討中。一方通行セルは未着手（PR #180 レビュー待ち）
